...
class CreadorOfertaVoter extends Voter
{
     ...
     * La lógica consiste en comparar si el id de la tienda que solicita el 
     * permiso coincide con el id asociado a la tienda de la oferta que se quiere modificar
     *
